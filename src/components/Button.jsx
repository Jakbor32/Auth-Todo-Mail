...
const Button = (props) => {
  return (
    ...
    >
      <span className="absolute right-0 w-8 h-32 -mt-12 transition-all duration-900 transform translate-x-12 bg-white opacity-10 rotate-12 group-hover:-translate-x-[100vw] ease"></span>
